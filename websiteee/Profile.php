...
<body>
    ...
    <nav class="navbar navbar-light navbar-expand-md">
        ...
        <div class="text-center border rounded-0 shadow-sm profile-box" style="width: 100%;height: 300px;background-color: #ffffff;margin: 5px;">
        ...
        <div class="col">
            <div class="row register-form">
                <div class="col-md-8 offset-md-2">
                    ...
                    <form class="custom-form" action="config.php" methord="post" enctype="multipart/form-data">
                        <h1>Upload Blog</h1>
                        <div class="row form-group">
                            <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Title</label></div>
                            <div class="col-sm-6 input-column"><input class="form-control" type="text" name="blog_title"></div>
                        </div>
                        <div class="row form-group">
                            <div class="col-sm-4 label-column"><label class="col-form-label" for="email-input-field">Description</label></div>
                            <div class="col-sm-6 input-column"><input class="form-control" type="text" name="blog_description"></div>
                        </div>
                        <div class="row form-group">
                            <div class="col-sm-4 label-column"><label class="col-form-label" for="pawssword-input-field">Blog Content</label></div>
                            <div class="col-sm-6 input-column"><textarea class="form-control" type="text" name="blog_content"> </textarea></div>
                        </div>
                        <div class="row form-group">
                            <div class="col-sm-4 label-column"><label class="col-form-label" for="email-input-field">Image Url</label></div>
                            <div class="col-sm-6 input-column"><input class="form-control" type="text" name="blog_img"></div>
                        </div>
 <button class="btn btn-light submit-button" type="submit">Upload</button>
                    </form>
                </div>
            </div>
        </div>
